...
import LucidRecruiterRepository from '#infrastructure/repositories/lucid_recruiter_repository'
...
export default class AppProvider {
  ...
  async boot() {
    ...
    this.app.container.bind(RecruiterRepository, () => new LucidRecruiterRepository())
  }
